  ...
  try {
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        system: system || 'You are a helpful supplement advisor for Kurryculum. Help users find the right supplements for their health goals and lifestyle. Be concise (2-3 sentences) and science-based. Always recommend consulting a doctor. For personalised advice suggest kurryculum.com/consult.',
        messages: messages
      })
    });
    if (!response.ok) {
